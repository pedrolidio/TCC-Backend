function errorHandler(err, req, res, next) {
  ...
  const messages = {
    ...
    DUPLICATE_VIN: "Veículo com VIN (númeração do chassi) já cadastrado!",
    INVALID_YEAR: "O ano do veículo deve ser um número positivo válido.",
    INVALID_VIN: "Formato de VIN (númeração do chassi) inválido!",
    INVALID_LICENSE_PLATE: "Formato de placa inválido!",
